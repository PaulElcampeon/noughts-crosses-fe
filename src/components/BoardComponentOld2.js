...
class BoardComponent extends Component {
    ...
    sendActionRequest = (e) => {
        ...
        for (let row = 0; row < 3; row++) {
            for (let column = 0; column < 3; column++) {
                ...
                console.log("Y between: " + this.blockPositions[row][column].y + " - " + this.blockPositions[row][column].y + this.blockHeight + 
                    "\nX between: " + this.blockPositions[row][column].x + " - " + this.blockPositions[row][column].x + this.blockWidth)
                console.log(e.offsetY > this.blockPositions[row][column].y && e.offsetY < this.blockPositions[row][column].y + this.blockHeight
                    && e.offsetX > this.blockPositions[row][column].x && e.offsetX < this.blockPositions[row][column].x + this.blockWidth
                    && this.props.board.positions[row][column] === 0)
    ...
    render() {
        return (
            <div className="m-auto board-container">
